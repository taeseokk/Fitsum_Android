...
//          if (squart!! >= 50) {
//            changeUserCoinDto.curUserCoin = coin
//            changeUserCoinDto.newUserCoin = coin!! + 30
//            //코인 지급
//            changeAPI.updateUserCoin(changeUserCoinDto)
//              .enqueue(object : Callback<SingleResult<*>?> {
//                override fun onResponse(
//                  call: Call<SingleResult<*>?>,
//                  response: Response<SingleResult<*>?>
//                ) {
//                  if (response.isSuccessful) {
//                    Toast.makeText(activity, "코인이 지급되었습니다.", Toast.LENGTH_SHORT).show()
//                  }
//                }
//
//                override fun onFailure(call: Call<SingleResult<*>?>, t: Throwable) {}
    ...
    fin_pushup?.setOnClickListener {
      ...
      val builder = AlertDialog.Builder(activity)
        ...
        .setPositiveButton("종료"){ dialog, which ->
          ...
          exerciseAPI.pushup(pushup).enqueue(object : Callback<CommonResult?> {
            override fun onResponse(call: Call<CommonResult?>, response: Response<CommonResult?>) {
              if (response.isSuccessful) {
                val data = response.body()
              }
